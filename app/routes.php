...
Route::group(array('prefix' => 'author'), function()
{
	...
	Route::group(array('prefix' => 'blogs'), function()
	{
		Route::get('/', array('as' => 'author/blogs', 'uses' => 'Controllers\Author\BlogsController@getIndex'));
		Route::get('create', array('as' => 'author/create/blog', 'uses' => 'Controllers\Author\BlogsController@getCreate'));
		Route::post('create', 'Controllers\Author\BlogsController@postCreate');
		Route::get('{blogId}/edit', array('as' => 'author/update/blog', 'uses' => 'Controllers\Author\BlogsController@getEdit'));
		Route::post('{blogId}/edit', 'Controllers\Author\BlogsController@postEdit');
		Route::get('{blogId}/delete', array('as' => 'author/delete/blog', 'uses' => 'Controllers\Author\BlogsController@getDelete'));
		Route::get('{blogId}/restore', array('as' => 'author/restore/blog', 'uses' => 'Controllers\Author\BlogsController@getRestore'));
	});
});
