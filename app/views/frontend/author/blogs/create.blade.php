...
<div class="page-header">
	<h3>
		...
		<div class="pull-right">
			<a href="{{ route('author/blogs') }}" class="btn btn-small btn-inverse"><i class="icon-circle-arrow-left icon-white"></i> Back</a>
		</div>
	</h3>
</div>
...
<form class="form-horizontal" method="post" action="" autocomplete="off">
	...
	<div class="control-group">
		<div class="controls">
			<a class="btn btn-link" href="{{ route('author/blogs') }}">Cancel</a>
